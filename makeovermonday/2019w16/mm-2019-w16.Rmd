...
p_tfidf <- top_10_tfidf %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = 'Importance of words in "Info We Trust" book sections',
       subtitle = paste0("\n", str_wrap(subtitle_text, width = 160), "\n", collapse = ""),
  ...
  theme(strip.background = element_blank(), 
        ...
        plot.subtitle = element_text(colour = "white", size = 9),
...
MakeoverMonday 2016/W16 focuses on the words in ["Info We Trust"](https://infowetrust.com/). The original viz is a [word cloud](https://twitter.com/TriMyData/status/1117386318391197698). Data is available [here](https://data.world/makeovermonday/2019w16).
